...
export type TaskActionModel =
  | {
      ...
      payload?: TaskModel; // payload é opcional, pode ser usado para enviar dados extras
    }
  | {
      type: TaskActionTypes.CHANGE_SETTINGS;
      payload?: TaskStateModel['config']; // payload é opcional, pode ser usado para enviar dados extras
    }
  | {
      type: TaskActionTypes.COUNT_DOWN;
      payload: { secondsRemaining: number }; // payload é opcional, pode ser usado para enviar dados extras
    }
  | {
